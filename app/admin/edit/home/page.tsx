...
import { Image as ImageIcon, Upload, Save, ArrowLeft, Type, MapPin, Info, Palette, CheckCircle2, Link as LinkIcon, Plus, Trash2 } from "lucide-react";
...
export default function EditHomePage() {
  ...
  const handleRemoveSlide = (index: number) => {
    if (heroSlides.length <= 1) return; // Keep at least one slide
